...
const Home = () => {
    return ( 
        <main>
            ...
            <div className="icons">
                <img src={process.env.PUBLIC_URL + "/icons/html5.svg"} alt="html" className="icon"/>
                <img src={process.env.PUBLIC_URL + "/icons/css3-alt.svg"} alt="css" className="icon"/>
                <img src={process.env.PUBLIC_URL + "/icons/js.svg"} alt="javascript" className="icon" />
                <img src={process.env.PUBLIC_URL + "/icons/react.svg"} alt="react" className="icon"/>
            </div>
        </main>
     );
}
